...
#define C_CORAL 0xE3A0 // B zeroed, see the panel note below (was 0xE3A8)
#define C_TEXT TFT_WHITE
#define C_MUTED 0x8C71
#define C_OK 0x256C   // refined green
#define C_NO 0xC1C0   // muted red, B zeroed (was 0xC1C5)
#define C_FACE 0x2966 // neutral button face (dark slate)
// Info-card fill (very dark slate). Calibrated, not theoretical: this panel
// renders the neutral 0x10A3 (R2 G5 B3) as navy -- reproduced at 55 and
// 40 MHz SPI, and with the stock ILI9341 gamma curves written in, so it is
// the panel itself. Warmed, blue pulled to 1.
// ponytail: eyeball-tuned on one unit -- this constant is the knob.
#define C_CARD 0x18A1 // R3 G5 B1
